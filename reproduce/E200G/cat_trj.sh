...
files=$(ls -v run*/md_run/E200G.xtc)
...
echo "1 1" | gmx trjconv -f cat_trj.xtc -s run1/md_run/E200G.tpr -center yes -o centered_traj.xtc -nobackup

echo "4 1" | gmx trjconv -f centered_traj.xtc -s run1/md_run/E200G.tpr -fit rot+trans -o fitted_traj.xtc -nobackup
